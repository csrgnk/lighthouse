...
const UIStrings = {
  ...
  title: 'Server response times are low',
  ...
  failureTitle: 'Reduce server response times',
  ...
  description: 'Server Response Time identifies the time at which your server sends a response.' +
